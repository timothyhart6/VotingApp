...
{
    public class SenateMember : ISenator
    {

        public ISenator CreateSenator()
        {
            Senator senator = new Senator();
            return (ISenator)senator;
        }
    ...
    public class SenateResult
    {
        ...
        public List<SenateMember> SenateMembers { get; set; }
    }
    ...
    public class Senator
    {
        ...
        public List<SenateResult> SenateResults { get; set; }
    }
}